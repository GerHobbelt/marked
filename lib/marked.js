...
(function() {
    ...
    Renderer.prototype.code = function(code, lang, escaped) {
        ...
        return '<pre' (this.options.highlightClass ? ' class="' + escape(this.options.highlightClass, true) + '"' : '') + '><code' (lang ? ' class="' + this.options.langPrefix + escape(lang, true) + '"' : '') + '>' (escaped ? code : escape(code, true)) + '\n</code></pre>\n';
    };
