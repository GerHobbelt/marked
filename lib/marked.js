...
(function() {
    ...
    Renderer.prototype.code = function(code, lang, escaped) {
        ...
        if (!lang) {
            return '<pre><code' + ((this.options.highlight) ? ' class="hljs"' : '') + '>' + (escaped ? code : escape(code, true)) + '\n</code></pre>';
        }

        return '<pre><code class="' + this.options.langPrefix + escape(lang, true) + ((this.options.highlight) ? ' hljs' : '') + '">' + (escaped ? code : escape(code, true)) + '\n</code></pre>\n';
    };
